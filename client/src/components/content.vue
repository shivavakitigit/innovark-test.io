<template>
    <div class="main">
        <div class="filter">
            ...
            <titleFilter> Course List </titleFilter>
...
const dattttttt = ["Java","ReactJS","FullStack Development","Frontend Development"]
onMounted(async () => {
    await axios
        .get('https://lxp-api-dev.azure-api.net/DevStage/courses/discovery-paginated?page=1&page_size=20&language=en')
        .then(response => {
            debugger
    ...
    if (store_categories.getAllCategories.length === 0) {
        await axios
            ...
            .then(response => {
                store_categories.add_all_categories(dattttttt)
